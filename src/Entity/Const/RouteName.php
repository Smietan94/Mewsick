...
class RouteName
{
    // spotify api controller names
    public const APP_START                   = 'app_start';
    public const APP_CREATE_SPOTIFY_PLAYLIST = 'app_create_spotify_playlist';
    ...
    public const APP_CATS_GALLERY            = 'app_cats_gallery';
}